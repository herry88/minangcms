...
class Minify
{
	...
	{
		require_once(APPPATH . 'libraries/ext/minify/minify/JSMin.php');
	...
	{
		require_once(APPPATH . 'libraries/ext/minify/minify/JSMinPlus.php');
	...
	{
		require_once(APPPATH . 'libraries/ext/minify/minify/cssmin-v3.0.1.php');
	...
	{
		require_once(APPPATH . 'libraries/ext/minify/minify/cssminify.php');
