<a href="<?=base_url(roleURIUser().'media/gallery/add');?>" class="btn btn-md btn-flat btn-default">Tambah Galeri</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        var oTable = $('#tb').dataTable({
            ...
            "bServerSide": true,
            "responsive": true,
            "sAjaxSource": '<?php echo base_url(roleURIUser()); ?>/media/gallery/viewdata',
            "bJQueryUI": false,
